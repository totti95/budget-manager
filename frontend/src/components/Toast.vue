<template>
  <Transition name="toast">
    <div
      v-if="visible"
      :class="[
        'fixed top-4 right-4 z-[9999] px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 min-w-[300px] max-w-[500px]',
        typeClasses,
      ]"
    >
      ...
      <button @click="close" class="flex-shrink-0 hover:opacity-75">
