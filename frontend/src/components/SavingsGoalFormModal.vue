  ...
  >
    ...
    >
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div>
          <label for="asset" class="block text-sm font-medium mb-1"
            >Actif lié (optionnel)</label
          >
          <select
            id="asset"
...
async function handleSubmit() {
  const targetAmount = parseFloat(
    formData.targetAmountEuros.toString()
  );
